...
const Header = () => {
  ...
  return (
    <header className="top-0 -mb-3 py-5 w-full mx-auto md:px-10 flex gap-10 justify-around items-center">
      <div className="w-10 h-10 lg:ml-20 md:ml-6">
        {homeRoute !== "/" && (
          <Link href={"/"}>
            <Image
              src={profile}
      ...
      <div className="flex md:flex-1 justify-end md:justify-center pt-2">
        {/* desktop navigation */}
